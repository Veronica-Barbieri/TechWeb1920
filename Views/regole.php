...
<h2 id="basi">Le basi del gioco</h2>
<p class="simpleText">
...
<h2 id="tipi">Tipi di carte</h2>
<ul>
  <li>
    <h3 id="tipi_terra">Terre</h3>
    <p class="simpleText">
      ...
      altre carte del mazzo. Puoi giocare una terra durante la fase principale
      di ognuno dei tuoi turni e queste terre rimangono di fronte a te sul
      campo di battaglia. Le tue terre vengono STAPpate (raddrizzate) all’inizio
      di ogni tuo turno, pronte per essere usate di nuovo.
     </p>
     <p class="simpleText">
       Esistono cinque tipi di terre base, ognuno corrispondente a uno dei
       cinque colori
     </p>
     <ul class="listaMana">
  ...
  <li>
    ...
    <p class="simpleText">
      ...
      altri producono il loro effetto e poi vengono messi nel tuo cimitero (la
      pila degli scarti).
    </p>
  </li>
  <li>
    <h3 id="tipi_creature">Creature</h3>
    <p class="simpleText">
      ...
      dagli assalti nemici. Puoi lanciare le magie creatura durante la tua fase
      principale.
    </p>
  </li>
  <li>
    <h3 id="tipi_inc">Artefatti e incantesimi</h3>
    <p class="simpleText">
      ...
      quindi non richiedono mana di un colore specifico per essere lanciati.
      Alcuni artefatti sono anche creature. Puoi lanciare le magie artefatto e
      incantesimo durante la tua fase principale.
    </p>
  </li>
  <li>
    <h3 id="tipi_streg">Stregonerie e istantanei</h3>
    <p class="simpleText">
      ...
      effetto è avvenuto, queste magie vengono messe nel tuo cimitero. Puoi
      lanciare una stregoneria solo durante la tua fase principale, quando
      potresti lanciare creature e altre magie permanente. Gli istantanei,
      invece, possono essere lanciati nel turno di qualsiasi giocatore,
      praticamente in ogni momento. . . addirittura in risposta a un’altra magia!
    </p>
  </li>
  <li>
    <h3 id="tipi_planeswalker">Planeswalker</h3>
    <p class="simpleText">
...
<h2 id="lanciare">Giocare una carta</h2>
<p class="simpleText">
...
<p class="simpleText">
  Per pagare un costo di mana, TAPpa (ruota di lato) le terre necessarie sul campo
  di battaglia; in questo modo, mostrerai che le hai utilizzate per produrre
  mana. Le carte TAPpate vengono STAPpate all’inizio di ogni tuo turno, pronte
  per essere usate di nuovo. Per lanciare il Drago di Shivan, puoi TAPpare due
