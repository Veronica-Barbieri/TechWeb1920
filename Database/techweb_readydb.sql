...
CREATE TABLE `carta` (
  ...
  `Rarita` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'Time Sieve', 'Blu', 0, 0, 1, 0, 1, 0, 'Artefatto', 'Sacrifice five artifacts: Take an extra turn\n  after this one.', '\"Prego di non essere mai considerata vecchia o inutile\" -- Sharuum Egemone', 'Set Base Nona Edizione', 'Rara', 'Franz', NULL, NULL, 'Resources/carta20.jpg'),
(2, 'Forest', 'Verde', NULL, NULL, NULL, NULL, NULL, NULL, 'Terra', NULL, NULL, 'Set Base Quarta Edizione', 'Terra', 'John Avon', NULL, NULL, 'Resources/carta4.jpeg'),
(3, 'Magmaw', 'Rosso', 0, 2, 0, 0, 0, 3, 'Creatura', 'Sacrifice a nonland permanent:\n  Magmaw deals 1 damage to any target.', '\"The purpose of existence is simple:\n  everything is fuel for the magmaw.\" —Jaji, magmaw worshipper', 'Set Base 2018', 'Rara', 'Karl Kopinski', 4, 4, 'Resources/carta5.jpeg'),
