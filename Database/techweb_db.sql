...
--
-- Host: 127.0.0.1
-- Creato il: Nov 09, 2019 alle 17:19
...
CREATE TABLE `carta` (
  ...
  `Edizione` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Rarità` text COLLATE utf8mb4_unicode_ci NOT NULL,
