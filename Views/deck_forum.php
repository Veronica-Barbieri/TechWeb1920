...
<div class="wiki_nav">
  ...
  <div class="btn_box">
    <?php if ($num_pages>=2) {?>
      <a href="deck_forum.php?page=1"> <span class="fas fa-angle-double-left"></span> </a>
    <?php }
    if ($cur_page>1) {?>
      <a href="deck_forum.php?page=<?php echo $cur_page-1; ?>"> <span class="fas fa-angle-left"></span> </a>
    <?php }
    if ($cur_page>2) {?>
      <a href="deck_forum.php?page=<?php echo $cur_page-2; ?>"><?php echo $cur_page-2; ?></a>
    <?php }
    if ($cur_page>1) {?>
      <a href="deck_forum.php?page=<?php echo $cur_page-1; ?>"><?php echo $cur_page-1; ?></a>
    <?php } ?>
    ...
    if ($num_pages-$cur_page>=1) {?>
      <a href="deck_forum.php?page=<?php echo $cur_page+1; ?>"> <span class="fas fa-angle-right"></span> </a>
    <?php }
    if ($num_pages>=2) {?>
      <a href="deck_forum.php?page=<?php echo $num_pages; ?>"> <span class="fas fa-angle-double-right"></span> </a>
    <?php } ?>
  </div>
</div>
