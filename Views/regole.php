    ...
    <ul>
      ...
      <li>
        ...
        <p class="simpleText">
          ...
          <a class="linkText" id="Planeswalker" href="https://magic.wizards.com/it/game-info/story/planeswalkers/how-planeswalker-cards-work">
            Regole delle carte Planeswalker.
          </a>
        </p>
      </li>
    </ul>
    <h1 class="sez_title" id="lanciare">Giocare una carta</h1>
    <p class="simpleText">
